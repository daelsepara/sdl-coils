...
namespace Character
{
    ...
    auto SANDEK = Character::Base("The Sandek", Character::Type::SANDEK, "Your ruthlessness and ambition have made you a respected leader of the Godomo underworld.", {Skill::ROGUERY, Skill::SEAFARING, Skill::STREETWISE, Skill::SWORDPLAY}, {Item::SWORD}, 10, 20);
    ...
    auto SCHNORER = Character::Base("The Schnorer", Character::Type::SCHNORER, "You live by your wits, a familiar figure on the streets of Godomo where you are famous for your audacity.", {Skill::CUNNING, Skill::ROGUERY, Skill::STREETWISE, Skill::UNARMED_COMBAT}, {}, 11, 7);
