...
namespace Character
{
    ...
    auto AVENGER = Character::Base("The Avenger", Character::Type::AVENGER, "Your life is dedicated to settling blood feuds. If there is injustice, you are called upon to even the score.", {Skill::AGILITY, Skill::STREETWISE, Skill::SWORDPLAY, Skill::UNARMED_COMBAT}, {Item::SWORD}, 10, 10);
    auto SANDEK = Character::Base("The Sandek", Character::Type::SANDEK, "Your ruthlessness and ambition have made you a respected leader of the Godorno underworld.", {Skill::ROGUERY, Skill::SEAFARING, Skill::STREETWISE, Skill::SWORDPLAY}, {Item::SWORD}, 10, 20);
    auto CHAKHAM = Character::Base("The Chakham", Character::Type::CHAKHAM, "You have preserved the sacred traditions with pride. Now use your skills and wisdom to become the saviour of your people.", {Skill::AGILITY, Skill::CHARMS, Skill::FOLKLORE, Skill::UNARMED_COMBAT}, {Item::MAGIC_AMULET}, 10, 10);
    auto CABBALIST = Character::Base("The Cabbalist", Character::Type::CABBALIST, "You have travelled far and wide in the study of magic and now it is time to put your knowledge to the test.", {Skill::CHARMS, Skill::FOLKLORE, Skill::SEAFARING, Skill::SPELLS}, {Item::MAGIC_AMULET, Item::MAGIC_WAND}, 10, 10);
    auto SCHNORER = Character::Base("The Schnorer", Character::Type::SCHNORER, "You live by your wits, a familiar figure on the streets of Godorno where you are famous for your audacity.", {Skill::CUNNING, Skill::ROGUERY, Skill::STREETWISE, Skill::UNARMED_COMBAT}, {}, 11, 7);
    auto NAZIRITE = Character::Base("The Nazirite", Character::Type::NAZIRITE, "Your talents derive from your holy vows, which endow you with great strength and luck.", {Skill::CHARMS, Skill::CUNNING, Skill::SWORDPLAY, Skill::WILDERNESS_LORE}, {Item::MAGIC_AMULET, Item::SWORD}, 12, 9);
    auto SEER = Character::Base("The Seer", Character::Type::SEER, "Your life amounted to nothing until the angel Raziel appeared to you in a vision and granted you second sight.", {Skill::CUNNING, Skill::ROGUERY, Skill::SPELLS, Skill::SWORDPLAY}, {Item::MAGIC_WAND, Item::SWORD}, 10, 10);
